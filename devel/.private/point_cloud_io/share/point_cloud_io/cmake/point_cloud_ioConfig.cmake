...
if("TRUE" STREQUAL "TRUE")
  set(point_cloud_io_SOURCE_PREFIX /home/zyt/zyt_0526/src/point_cloud_io)
  set(point_cloud_io_DEVEL_PREFIX /home/zyt/zyt_0526/devel/.private/point_cloud_io)
  ...
  set(point_cloud_io_INSTALL_PREFIX /home/zyt/zyt_0526/install)
...
if(NOT "/home/zyt/zyt_0526/src/point_cloud_io/include " STREQUAL " ")
  set(point_cloud_io_INCLUDE_DIRS "")
  set(_include_dirs "/home/zyt/zyt_0526/src/point_cloud_io/include")
  if(NOT "http://github.com/anybotics/point_cloud_io/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'http://github.com/anybotics/point_cloud_io/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://github.com/anybotics/point_cloud_io " STREQUAL " ")
    set(_report "Check the website 'http://github.com/anybotics/point_cloud_io' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Remo Diethelm <rdiethelm@anybotics.com>, Yoshua Nava <ynava@anybotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_cloud_io' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zyt/zyt_0526/src/point_cloud_io/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT point_cloud_io_NUM_DUMMY_TARGETS)
      set(point_cloud_io_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::point_cloud_io::wrapped-linker-option${point_cloud_io_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR point_cloud_io_NUM_DUMMY_TARGETS "${point_cloud_io_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::point_cloud_io::wrapped-linker-option${point_cloud_io_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND point_cloud_io_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zyt/zyt_0526/devel/.private/point_cloud_io/lib;/home/zyt/zyt_0526/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(point_cloud_io_EXPORTED_TARGETS ${${point_cloud_io_dep}_EXPORTED_TARGETS})
endforeach()
