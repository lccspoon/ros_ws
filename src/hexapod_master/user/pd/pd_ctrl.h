...
class pd_ctrl
{
    ...
    public:
        ...
        double* pdTau(double * joi_act_pos,double * joi_des_pos,double * joi_act_vel,double * joi_des_vel)
        {
            for (int i = 0; i < 3; i++)
            {   
        ...
        double* positonPidTau(double * joi_act_pos,double * joi_des_pos,double * joi_act_vel,double * joi_des_vel)
        {
            for (int i = 0; i < 3; i++)
            {   
        ...
        double* incrementPidTau(double * joi_act_pos,double * joi_des_pos,double * joi_act_vel,double * joi_des_vel)
        {
            for (int i = 0; i < 3; i++)
            {   
