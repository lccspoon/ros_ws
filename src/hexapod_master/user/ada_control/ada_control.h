...
class ada_ctrl
{
    ...
    public:
        ...
        Eigen::Matrix<double,3,1> adaTau(Matrix<double,3,1>joi_act_pos,Matrix<double,3,1>joi_des_pos,Matrix<double,3,1>joi_act_vel,Matrix<double,3,1> joi_des_vel)
        {
            for (int i = 0; i < 3; i++)
            {   
