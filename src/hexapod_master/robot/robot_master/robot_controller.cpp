...
void Hexapod::liftReaction(void)
{
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        if(  cpg_touch_down_scheduler(i)==1 && swing_traj_switch_flag[i]==1 ) //如果cpg是摆动
        {
            ...
            neur_bezier[i].lamdaX(0)=neur_bezier[i].lamdaX_conver[0].linearConvert( neur_bezier[i].lamdaX(0), 10, tt);
            neur_bezier[i].lamdaX(1)=neur_bezier[i].lamdaX_conver[1].linearConvert( neur_bezier[i].lamdaX(1), -20, tt);
            neur_bezier[i].lamdaX(2)=neur_bezier[i].lamdaX_conver[2].linearConvert( neur_bezier[i].lamdaX(2), 10, tt);
            neur_bezier[i].lamdaX(3)=neur_bezier[i].lamdaX_conver[3].linearConvert( neur_bezier[i].lamdaX(3), 10, tt);
            neur_bezier[i].lamdaX(4)=neur_bezier[i].lamdaX_conver[4].linearConvert( neur_bezier[i].lamdaX(4), 10, tt);
            neur_bezier[i].lamdaX(5)=neur_bezier[i].lamdaX_conver[5].linearConvert( neur_bezier[i].lamdaX(5), 10, tt);
            neur_bezier[i].lamdaX(6)=neur_bezier[i].lamdaX_conver[6].linearConvert( neur_bezier[i].lamdaX(6), 10, tt);
            neur_bezier[i].lamdaX(7)=neur_bezier[i].lamdaX_conver[7].linearConvert( neur_bezier[i].lamdaX(7), 10, tt);
            neur_bezier[i].lamdaX(8)=neur_bezier[i].lamdaX_conver[8].linearConvert( neur_bezier[i].lamdaX(8), 40, tt);

            neur_bezier[i].lamdaY(0)=neur_bezier[i].lamdaY_conver[0].linearConvert( neur_bezier[i].lamdaY(0), 10, tt);
            neur_bezier[i].lamdaY(1)=neur_bezier[i].lamdaY_conver[1].linearConvert( neur_bezier[i].lamdaY(1), 10, tt);
            neur_bezier[i].lamdaY(2)=neur_bezier[i].lamdaY_conver[2].linearConvert( neur_bezier[i].lamdaY(2), 1, tt);
            neur_bezier[i].lamdaY(3)=neur_bezier[i].lamdaY_conver[3].linearConvert( neur_bezier[i].lamdaY(3), 30, tt);
            neur_bezier[i].lamdaY(4)=neur_bezier[i].lamdaY_conver[4].linearConvert( neur_bezier[i].lamdaY(4), 30, tt);
            neur_bezier[i].lamdaY(5)=neur_bezier[i].lamdaY_conver[5].linearConvert( neur_bezier[i].lamdaY(5), 10, tt);
            neur_bezier[i].lamdaY(6)=neur_bezier[i].lamdaY_conver[6].linearConvert( neur_bezier[i].lamdaY(6), 60, tt);
            neur_bezier[i].lamdaY(7)=neur_bezier[i].lamdaY_conver[7].linearConvert( neur_bezier[i].lamdaY(7), 30, tt);
            neur_bezier[i].lamdaY(8)=neur_bezier[i].lamdaY_conver[8].linearConvert( neur_bezier[i].lamdaY(8), 10, tt);
