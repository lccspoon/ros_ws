...
{   private:
    ...
    public:
        ...
        Eigen::Vector3d invKinematic(Eigen::Vector3d Position_);
        Eigen::Vector3d forwardKinematic(Eigen::Vector3d angle_);
        ...
        //20230518 足端修正
        Eigen::Vector3d CorrinvKinematic(Eigen::Vector3d Position_);
};
