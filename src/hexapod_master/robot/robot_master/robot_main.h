...
#include"../../user/wbc/QPForce712.h"
#include"../../user/wbc/cppTypes.h" //20230519 机身控制
...
#define SIM_CTRL_MODE 2  // 仿真算法：1 -> position control  2-> pd control
...
{
    private:
        LegParameter _Lf,_Lm,_Lb,_Rf,_Rm,_Rb;
        kinematic _LfKin,_LmKin,_LbKin,_RfKin,_RmKin,_RbKin;
        //zyt20230518足端修正
        kinematic _LfCorrKin,_LmCorrKin,_LbCorrKin,_RfCorrKin,_RmCorrKin,_RbCorrKin;
        neural_bezier_curve _LfTraj,_LmTraj,_LbTraj,_RfTraj,_RmTraj,_RbTraj;
        CPG _Cpg;
        ...
        linear_trans _LfStaPosLinTrans,_LmStaPosLinTrans,_LbStaPosLinTrans,_RfStaPosLinTrans,_RmStaPosLinTrans,_RbStaPosLinTrans;
        linear_trans _LfSetStaticStandPosLinTrans,_LmSetStaticStandPosLinTrans,_LbSetStaticStandPosLinTrans,
                     _RfSetStaticStandPosLinTrans,_RmSetStaticStandPosLinTrans,_RbSetStaticStandPosLinTrans;

        linear_trans _LfStepLKTrans,_LmStepLKTrans,_LbStepLKTrans,_RfStepLKTrans,_RmStepLKTrans,_RbStepLKTrans;
        linear_trans _LfStepWKTrans,_LmStepWKTrans,_LbStepWKTrans,_RfStepWKTrans,_RmStepWKTrans,_RbStepWKTrans;

        DataUnusualProtect _LfDatUnuProtect,_LmDatUnuProtect,_LbDatUnuProtect,
                            _RfDatUnuProtect,_RmDatUnuProtect,_RbDatUnuProtect;
        ...
        QPForce712 _QPforce;  //20230519 zyt 机身控制
    ...
    public:
        ...
        */
        ...
        void wbcController(void); //zyt20230519 机身控制
