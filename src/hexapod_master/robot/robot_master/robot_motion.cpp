...
{
    _Rb._FooBodAdjMap.step_amplitude=_Rb._FooBodAdjMap.SteAmpLinTran.linearConvert(_Rb._FooBodAdjMap.step_amplitude,rb_step_amplitude,switch_period);
    _Rm._FooBodAdjMap.step_amplitude=_Rm._FooBodAdjMap.SteAmpLinTran.linearConvert(_Rm._FooBodAdjMap.step_amplitude,rm_step_amplitude,switch_period);
    _Rf._FooBodAdjMap.step_amplitude=_Rf._FooBodAdjMap.SteAmpLinTran.linearConvert(_Rf._FooBodAdjMap.step_amplitude,rf_step_amplitude,switch_period);
    _Lb._FooBodAdjMap.step_amplitude=_Lb._FooBodAdjMap.SteAmpLinTran.linearConvert(_Lb._FooBodAdjMap.step_amplitude,lb_step_amplitude,switch_period);
    _Lm._FooBodAdjMap.step_amplitude=_Lm._FooBodAdjMap.SteAmpLinTran.linearConvert(_Lm._FooBodAdjMap.step_amplitude,lm_step_amplitude,switch_period);
    _Lf._FooBodAdjMap.step_amplitude=_Lf._FooBodAdjMap.SteAmpLinTran.linearConvert(_Lf._FooBodAdjMap.step_amplitude,lf_step_amplitude,switch_period);
...
{
    _Rb._FooBodAdjMap.rzz=_Rb._FooBodAdjMap.RzzLinTran.linearConvert(_Rb._FooBodAdjMap.rzz,rb_rzz*_RAD1,switch_period);
    _Rm._FooBodAdjMap.rzz=_Rm._FooBodAdjMap.RzzLinTran.linearConvert(_Rm._FooBodAdjMap.rzz,rm_rzz*_RAD1,switch_period);
    _Rf._FooBodAdjMap.rzz=_Rf._FooBodAdjMap.RzzLinTran.linearConvert(_Rf._FooBodAdjMap.rzz,rf_rzz*_RAD1,switch_period);
    _Lb._FooBodAdjMap.rzz=_Lb._FooBodAdjMap.RzzLinTran.linearConvert(_Lb._FooBodAdjMap.rzz,lb_rzz*_RAD1,switch_period);
    _Lm._FooBodAdjMap.rzz=_Lm._FooBodAdjMap.RzzLinTran.linearConvert(_Lm._FooBodAdjMap.rzz,lm_rzz*_RAD1,switch_period);
    _Lf._FooBodAdjMap.rzz=_Lf._FooBodAdjMap.RzzLinTran.linearConvert(_Lf._FooBodAdjMap.rzz,lf_rzz*_RAD1,switch_period);

}
void Hexapod::robTripleWalk()
{
    _Cpg.gait=_Cpg.GaitLinTran.linearConvert(_Cpg.gait,0.5,100); 
}
...
{
    _Cpg.gait=_Cpg.GaitLinTran.linearConvert(_Cpg.gait,0.833,100); 
}
...
void Hexapod::setStandPose(void)
{
        ...
        static_pos<< 3.7*0.01, 9*0.01, -13.5*0.01;
        leg_root.foot_set_static_pos.block<3,1>(0,1)=static_pos;

        static_pos<< 1*0.01, 9*0.01, -13.5*0.01;
...
void Hexapod::robGoAhead(double amplitude)
{
    ...
    setSixLegSteAmplitude(amplitude,amplitude,amplitude,  amplitude,amplitude,amplitude,  200);
    setSixLegRzz(0,0,0,  0,0,0,  200);
}
void Hexapod::robGoBack(double amplitude)
{
    setSixLegSteAmplitude(amplitude,amplitude,amplitude,  amplitude,amplitude,amplitude,  200);
    setSixLegRzz(180,180,180,  180,180,180,  200);
}
void Hexapod::robGoLeft(double amplitude)
{

    setSixLegSteAmplitude(amplitude,amplitude,amplitude,  amplitude,amplitude,amplitude,  200);
    setSixLegRzz(-90,-90,-90,  -90,-90,-90,  200);
}
...
void Hexapod::robTurnRightAround(double amplitude)
{
    ...
    setSixLegSteAmplitude(amplitude,amplitude,amplitude,  amplitude,amplitude,amplitude,  200);
    setSixLegRzz(180,180,180,  0,0,0,  200);
}
void Hexapod::robTurnLeftAround(double amplitude)
{

    setSixLegSteAmplitude(amplitude,amplitude,amplitude,  amplitude,amplitude,amplitude,  200);
    setSixLegRzz(0,0,0,  180,180,180,  200);
}
