...
void ROSLegTopicHandle::legGazeboSimInit(int argc, char *argv[])
{
    ...
    lfLegPub[0]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L1_1_jointcc/command",1000);
    lfLegPub[1]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L1_2_jointcc/command",1000);
    lfLegPub[2]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L1_3_jointcc/command",1000);

    lmLegPub[0]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L2_1_jointcc/command",1000);
    lmLegPub[1]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L2_2_jointcc/command",1000);
    lmLegPub[2]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L2_3_jointcc/command",1000);

    lbLegPub[0]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L3_1_jointcc/command",1000);
    lbLegPub[1]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L3_2_jointcc/command",1000);
    lbLegPub[2]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/L3_3_jointcc/command",1000);

    rfLegPub[0]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R1_1_jointcc/command",1000);
    rfLegPub[1]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R1_2_jointcc/command",1000);
    rfLegPub[2]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R1_3_jointcc/command",1000);

    rmLegPub[0]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R2_1_jointcc/command",1000);
    rmLegPub[1]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R2_2_jointcc/command",1000);
    rmLegPub[2]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R2_3_jointcc/command",1000);

    rbLegPub[0]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R3_1_jointcc/command",1000);
    rbLegPub[1]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R3_2_jointcc/command",1000);
    rbLegPub[2]=ROSLegTopicHandle.advertise<std_msgs::Float64>("/new/R3_3_jointcc/command",1000);

    yobotics_imu_msg = ROSLegTopicHandle.subscribe<sensor_msgs::Imu>("/imu",1000,doMsg_yobotics_imu_msg);
    yobotics_joint_states = ROSLegTopicHandle.subscribe<sensor_msgs::JointState>("/new/joint_states",1000,doMsg_yobotics_joint_states);
