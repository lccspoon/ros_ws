...
void HardwareBridge::dataIntegrat(void)
{
    ...
    whole_vel_data(6)=lb_act_vel(0);whole_vel_data(7)=lb_act_vel(1);whole_vel_data(8)=lb_act_vel(2);
    whole_vel_data(9)=rf_act_vel(0);whole_vel_data(10)=rf_act_vel(1);whole_vel_data(11)=rf_act_vel(2);
    whole_vel_data(12)=rm_act_vel(0);whole_vel_data(13)=rm_act_vel(1);whole_vel_data(14)=rm_act_vel(2);
    whole_vel_data(15)=rb_act_vel(0);whole_vel_data(16)=rb_act_vel(1);whole_vel_data(17)=rb_act_vel(2);
...
{   mtx9.lock();
    ...
    printf("rec lf_act_pos: ");     for(int i=0;i<3;i++)  printf(" %5f ",lf_act_pos(i)*_RAD2);    printf("\n");
    printf("rec lm_act_pos: ");     for(int i=0;i<3;i++)  printf(" %5f ",lm_act_pos(i)*_RAD2);    printf("\n");
    printf("rec lb_act_pos: ");     for(int i=0;i<3;i++)  printf(" %5f ",lb_act_pos(i)*_RAD2);    printf("\n");
    printf("rec rf_act_pos: ");     for(int i=0;i<3;i++)  printf(" %5f ",rf_act_pos(i)*_RAD2);    printf("\n");
    printf("rec rm_act_pos: ");     for(int i=0;i<3;i++)  printf(" %5f ",rm_act_pos(i)*_RAD2);    printf("\n");
    printf("rec rb_act_pos: ");     for(int i=0;i<3;i++)  printf(" %5f ",rb_act_pos(i)*_RAD2);    printf("\n"); printf("\n");
    printf("\n");
    mtx9.unlock();
