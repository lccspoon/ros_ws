...
#ifndef __exlcm_imu_type_hpp__
#define __exlcm_imu_type_hpp__
...
int imu_type::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_type::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int imu_type::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t imu_type::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* imu_type::getTypeName()
{
    return "imu_type";
}

int imu_type::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->euler[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int imu_type::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->euler[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int imu_type::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t imu_type::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x271cbdd62f79d61bLL;
