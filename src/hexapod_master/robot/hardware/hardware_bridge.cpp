...
{   printf("Send0 thread is :%lu,pid:%d\n",pthread_self(),getpid());
	...
	while(1)  //lcc 20230425: 发送前，检查角度是否突变
	{
        ...
        {
            HarBri.RfProtect.sendDataConPro(4,HarBri.rf_act_pos,5*HarBri._RAD1);
            for(int i=0;i<3;i++)
            {
        ...
        {   
            ...
            HarBri.RfProtect.sendDataConPro(4,HarBri.rf_des_pos,5*HarBri._RAD1);
...
{   printf("Send1 thread is :%lu,pid:%d\n",pthread_self(),getpid());
	...
	{	
        ...
        {
            HarBri.LfProtect.sendDataConPro(1,HarBri.lf_act_pos,5*HarBri._RAD1);
            for(int i=0;i<3;i++)
            {
        ...
        {   
            ...
            HarBri.LfProtect.sendDataConPro(1,HarBri.lf_des_pos,5*HarBri._RAD1);
            // printf("rfaaa:%d xx_can_dev_seq_last:%d  %d  %d \n",a,xx_can_dev_seq_last[0],xx_can_dev_seq_last[1],xx_can_dev_seq_last[2]);
        }
...
{   printf("Send2 thread is :%lu,pid:%d\n",pthread_self(),getpid());
	...
	{	
        ...
        {
            HarBri.LmProtect.sendDataConPro(2,HarBri.lm_act_pos,5*HarBri._RAD1);
            for(int i=0;i<3;i++)
            {
        ...
        {   
            ...
            HarBri.LmProtect.sendDataConPro(2,HarBri.lm_des_pos,5*HarBri._RAD1);
            // printf("rfaaa:%d xx_can_dev_seq_last:%d  %d  %d \n",a,xx_can_dev_seq_last[0],xx_can_dev_seq_last[1],xx_can_dev_seq_last[2]);
        }
...
{   printf("Send3 thread is :%lu,pid:%d\n",pthread_self(),getpid());
	...
	{	
        ...
        {
            HarBri.RmProtect.sendDataConPro(5,HarBri.rm_act_pos,5*HarBri._RAD1);
            for(int i=0;i<3;i++)
            {
        ...
        {   
            ...
            HarBri.RmProtect.sendDataConPro(5,HarBri.rm_des_pos,5*HarBri._RAD1);
            // printf("rfaaa:%d xx_can_dev_seq_last:%d  %d  %d \n",a,xx_can_dev_seq_last[0],xx_can_dev_seq_last[1],xx_can_dev_seq_last[2]);
        }
...
{   printf("Send4 thread is :%lu,pid:%d\n",pthread_self(),getpid());
	...
	{	
        ...
        {
            HarBri.RbProtect.sendDataConPro(6,HarBri.rb_act_pos,5*HarBri._RAD1);
            for(int i=0;i<3;i++)
            {
        ...
        {   
            ...
            HarBri.RbProtect.sendDataConPro(6,HarBri.rb_des_pos,5*HarBri._RAD1);
            // printf("rfaaa:%d xx_can_dev_seq_last:%d  %d  %d \n",a,xx_can_dev_seq_last[0],xx_can_dev_seq_last[1],xx_can_dev_seq_last[2]);
        }
...
{   printf("Send5 thread is :%lu,pid:%d\n",pthread_self(),getpid());
	...
	{	
        ...
        {
            HarBri.LbProtect.sendDataConPro(3,HarBri.lb_act_pos,5*HarBri._RAD1);
            for(int i=0;i<3;i++)
            {
        ...
        {   
            ...
            HarBri.LbProtect.sendDataConPro(3,HarBri.lb_des_pos,5*HarBri._RAD1);
            // printf("rfaaa:%d xx_can_dev_seq_last:%d  %d  %d \n",a,xx_can_dev_seq_last[0],xx_can_dev_seq_last[1],xx_can_dev_seq_last[2]);
        }
