                                                        ...
                                                        double swing_hight_threadhold)
{
    ...
    {       
            ...
            if(plan_touch_down_scheduler(i)==1 && contact_estimate_schedual(i)==0 && temp(2)>=swing_hight_threadhold*0.01)
            {       
                    // printf("\n");
    ...
    std::cout<<"foot_swing_traj"<<std::endl;
    std::cout<<foot_swing_traj<<std::endl;
    ...
    // for (int i = 0; i < 6; i++)
    // {
    //     if( leg_swingphase_contact_est(i)==1 )
    //     {
    //         exit(0);
    //     }
    // }
