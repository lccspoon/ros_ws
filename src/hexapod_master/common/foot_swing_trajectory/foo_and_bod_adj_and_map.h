...
class FooTipAndBodAdjMap
{
    ...
    public:
        ...
        static void fuselageAttiuCtrl(double r_yaw,double r_roll,double r_pitch)
        {
            RRR_YAW=r_yaw;RRR_ROLL=r_roll;RRR_PITCH=r_pitch;

        }
        static void fuselageDeviCtrl(double xx_deviate,double yy_deviate,double zz_zdeviate)
        {
