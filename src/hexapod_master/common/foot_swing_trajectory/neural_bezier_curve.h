...
class neural_bezier_curve
{
    private:
        ...
        double  Set_PX[9]={-3 *0.01, -2.5 *0.01, -1.5 *0.01, -0.5 *0.01, 0 *0.01, 0.5 *0.01, 1.5 *0.01, 2.5 *0.01, 3 *0.01};  //%%初始的轨迹图数据1
        double  Set_PY[9]={0*2 *0.01, 1.5*2 *0.01, 2.5*2 *0.01, 3.5*2 *0.01, 4.5*2 *0.01, 3.5*2 *0.01, 2.5*2 *0.01, 1.5*2 *0.01, 0*2 *0.01};
        ...
        MatrixXd kX,kY,aX,aY,XCn,YCn,lamdaX,lamdaY;
